...
$(window).load(function(){
  var submitButton = $(".submit_buttom")[0]
  submitButton.onclick = function() {
    ...
    var mailtoURL = createMailtoURL("tedxrutgers@gmail.com", "Website Feedback from ("+name+")", message)
...
$(window).load(function(){
  var submitButton = $("#nav-button-blog")[0]
  submitButton.onclick = function() {
    var submitButton = $("#nav-button-blog")[0]
    window.location = submitButton.attributes.getNamedItem("href").value;
  }
});